...
class DepartmentAdmin(admin.ModelAdmin):
    list_display = ('department_id', 'department_name', 'department_discipline', 'department_description')
    search_fields = ('department_name', 'department_discipline')
    inlines = [ProgramInline]

@admin.register(Program)
class ProgramAdmin(admin.ModelAdmin):
    list_display = ('program_id', 'program_name', 'program_code', 'number_of_semesters', 'program_description', 'department')
...
class CourseAdmin(admin.ModelAdmin):
    list_display = ('course_id', 'course_name', 'course_code', 'credit_hours', 'internal_marks', 'mid_marks', 'final_marks', 'course_description', 'semester')
